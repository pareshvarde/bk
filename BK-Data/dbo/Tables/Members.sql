CREATE TABLE [dbo].[Members] (
    ...
    [MaternalFamilyId] INT              NULL,
    [PaternalFamilyId] INT              NULL,
    ...
    CONSTRAINT [FK_MaternalFamilyId] FOREIGN KEY ([MaternalFamilyId]) REFERENCES [dbo].[Families] ([FamilyID]),
    CONSTRAINT [FK_PaternalFamilyId] FOREIGN KEY ([PaternalFamilyId]) REFERENCES [dbo].[Families] ([FamilyID])
);
